...
__align(32) u8 mem2base[MEM2_MAX_SIZE] __attribute__((at(0XC000100)));					//外部SDRAM内存池,前面2M给LTDC用了(1280*800*2)
__align(32) u8 mem3base[MEM3_MAX_SIZE] __attribute__((at(0X20010000)));					//内部DTCM内存池
//内存管理表
u32 mem1mapbase[MEM1_ALLOC_TABLE_SIZE];													//内部SRAM内存池MAP
u32 mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(0XC000100+MEM2_MAX_SIZE)));	//外部SRAM内存池MAP
