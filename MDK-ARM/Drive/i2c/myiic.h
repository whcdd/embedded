...
////////////////////////////////////////////////////////////////////////////////// 	
//IO方向设置
//#define SDA_IN()  {GPIOB->MODER&=~(3<<(11*2));GPIOB->MODER|=0<<11*2;GPIOB->PUPDR|=1<<11*2;}	//PB11输入模式
#define SDA_IN()  {GPIOB->MODER&=~(3<<(11*2));GPIOB->MODER|=0<<11*2;}	//PB11输入模式
//#define SDA_OUT() {GPIOB->MODER&=~(3<<(11*2));GPIOB->MODER|=1<<11*2;GPIOB->OTYPER|=1<<11;}   //PB11输出模式
...
extern float Temputerature;
extern uint16_t Temputerature_8,Temputerature_16;
#endif
